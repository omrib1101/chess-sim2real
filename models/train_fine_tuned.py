...
def parse_args():
    ...
    parser.add_argument("--output_model", default="my_fine_tuned.pth", help="Output model path")
...
def main():
    ...
    dataloaders = {
        "train": DataLoader(datasets["train"], batch_size=16, sampler=sampler, num_workers=4),
        "validation": DataLoader(datasets["validation"], batch_size=16, shuffle=False, num_workers=4)
    }
