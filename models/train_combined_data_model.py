...
if __name__ == "__main__":
    ...
    data_dir = "/home/noareg/my_project/data_for_train/train3"
    ...
    dataloaders = {
        'train': DataLoader(image_datasets['train'], batch_size=32, sampler=train_sampler, num_workers=4), # Sampler instead of shuffle
    ...
    torch.save(trained_model.state_dict(), 'chess_multitask_combine_2.pth')
