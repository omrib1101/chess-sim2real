...
Usage:
    "C:\Program Files\Blender Foundation\Blender 5.0\blender.exe" chess-set.blend --background --python chess_position_api_v2.py -- --fen "RNBKQBNR/PPPPPPPP/8/8/8/8/pppppppp/rnbkqbnr" --view white
"""
